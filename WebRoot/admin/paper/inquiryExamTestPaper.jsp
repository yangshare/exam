...
<table width="80%" border="0" align="center" cellpadding="5" cellspacing="0" class="InputFrameMain">
  ...
  <tr>
    ...
    <td nowrap><html:text name="addExaminationPaperForm" property="examinationPaper.e_name"/> </td>
    <td nowrap><div align="right" nowrap><b><font color="red">*</font></b>&nbsp;&nbsp;&nbsp;<bean:message key="examinationPaper.type" /></div></td>
    <td nowrap><html:select name="addExaminationPaperForm" property="examinationPaper.e_type"> <html:optionsCollection name="e_typeOpts"/> </html:select> </td>
    <td nowrap><div align="right" nowrap><b><font color="red">*</font></b>&nbsp;&nbsp;&nbsp;<bean:message key="examinationPaper.time" /></div></td>
    <td nowrap><html:text name="addExaminationPaperForm" property="examinationPaper.e_timer"/><bean:message key="examinationPaper.mi" /></td>
  </tr>
  <tr>
    <td nowrap>&nbsp;</td>
    <td nowrap height="8"> <div align="right" nowrap><bean:message key="examinationPaper.begin_time" /></div></td>
    <td nowrap><html:text name="addExaminationPaperForm" property="examinationPaper.e_begin" onfocus="setday(this)" readonly="true"/> </td>
    <td nowrap><div align="right" nowrap><b><font color="red">*</font></b>&nbsp;&nbsp;&nbsp;<bean:message key="examinationPaper.total" /></div></td>
    <td nowrap><html:text property="examinationPaper.e_total" readonly="true"/><bean:message key="examinationPaper.score" /></td>
    <td nowrap><div align="right" nowrap><b><font color="red">*</font></b>&nbsp;&nbsp;&nbsp;<bean:message key="examinationPaper.passvalue" /></div></td>
    <td nowrap><html:text property="examinationPaper.e_passvalue"/><bean:message key="examinationPaper.score" /></td>
  </tr>
  <tr>
    <td nowrap>&nbsp;</td>
    <td height="8"> <div align="right" nowrap><bean:message key="examinationPaper.end_time" /></div></td>
    <td nowrap> <html:text name="addExaminationPaperForm" property="examinationPaper.e_end" onfocus="setday(this)" readonly="true"/> </td>
    <td>&nbsp;</td>
    <td>&nbsp;</td>
    <td>&nbsp;</td>
    <td>&nbsp;</td>
