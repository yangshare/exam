...
<body>
  ...
  <html:errors/>
  <!--DWLayoutTable-->
  <html:form action="/admin/question/AUD_QuestionAction.do?action=single&method=addQuestion" method="post" enctype="multipart/form-data" onsubmit="return validateQuestionActionForm(this);">
    <table width="600" border="0" align="center" cellpadding="7" cellspacing="0" class="InputFrameMain">
      ...
      <tr>
        ...
        <td nowrap>
          <bean:message key="question.single"/>
        </td>
        <td nowrap>
          <div align="center">
            <strong>
