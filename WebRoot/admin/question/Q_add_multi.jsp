...
<head>
<title>
  <bean:message key="question.title.multi"/>
</title>
...
<body>
  ...
  <!--DWLayoutTable-->
  <html:form action="/admin/question/AUD_QuestionAction.do?action=multi&method=addQuestion" method="post" enctype="multipart/form-data" onsubmit="return validateQuestionActionForm(this);">
    <table width="600" border="0" align="center" cellpadding="7" cellspacing="0" class="InputFrameMain">
      ...
      <tr>
        ...
        <td nowrap>
         <bean:message key="question.multi"/>
        </td>
        <td nowrap>
          <div align="center">
            <strong>
    ...
    <table width="595" border="0" align="center" cellpadding="7" cellspacing="0" class="InputFrameMain">
      ...
      <tr>
        <td width="50%" nowrap>          &nbsp;
          <span class="InputAreaCell">
            <strong>
              <b><font color="red">*</font></b>&nbsp;&nbsp;&nbsp;<bean:message key="question.option"/>
              <br>
              <html:multibox value="A" name="questionActionForm" property="stringMultibox"/>
              <html:text name="questionActionForm" property="textfield1"/>
              <br>
              <html:multibox value="B" name="questionActionForm" property="stringMultibox"/>
              &nbsp;<html:text name="questionActionForm" property="textfield2"/>
              <br>
              <html:multibox value="C" name="questionActionForm" property="stringMultibox"/>
              &nbsp;<html:text name="questionActionForm" property="textfield3"/>
              <br>
              <html:multibox value="D" name="questionActionForm" property="stringMultibox"/>
              &nbsp;<html:text name="questionActionForm" property="textfield4"/>
              <br>
              <html:multibox value="E" name="questionActionForm" property="stringMultibox"/>
              &nbsp;<html:text name="questionActionForm" property="textfield5"/>
              <br>
            </strong>
          </span>
        </td>
