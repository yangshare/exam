...
<head>
<title>
  <bean:message key="question.title.answer"/>
</title>
...
<body>
  ...
  <!--DWLayoutTable-->
  <html:form action="/admin/question/AUD_QuestionAction.do?action=answer&method=addQuestion" method="post" enctype="multipart/form-data" onsubmit="return validateQuestionActionForm(this);">
    ...
    <table width="595" border="0" align="center" cellpadding="7" cellspacing="0" class="InputFrameMain">
      ...
      <tr>
        <td width="120" height="89" nowrap><bean:message key="question.content"/><span class="InputAreaCell">
            <strong>
              <br>
            </strong>
          </span>
