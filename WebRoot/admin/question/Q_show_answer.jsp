...
<body>
  ...
  <!--DWLayoutTable-->
  <html:form action="/admin/question/AUD_QuestionAction.do?action=answer&method=updateQuestion" method="post" enctype="multipart/form-data">
        ...
        <td width="50%" nowrap>          &nbsp;
          <span class="InputAreaCell">
            <strong>
              <bean:message key="question.standard"/>
              <br/>
              <html:textarea name="questionActionForm" property="question.q_standard" cols="40" rows="7">              </html:textarea>
            </strong>
          </span>
        </td>
        <td width="5%">        </td>
