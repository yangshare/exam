                    ...
                    <tr>
                      ...
                      <td width="680" style="WORD-BREAK: break-all">
                       <bean:message key="exam.q_standard"/>
                        ...
                        <br>
                       <bean:message key="exam.t_answer"/>
                        <bean:write name="multiQ" property="t_answer"/>
                        <br>
                       <bean:message key="exam.q_value"/>
                        <bean:write name="multiQ" property="q_value"/>
                        <br>
                        <bean:message key="exam.t_value"/>
                        <bean:write name="multiQ" property="t_value"/>
                        <br>
                      </td>
                    </tr>
                  </logic:iterate>
                    ...
                    <tr>
                      ...
                      <td width="680" style="WORD-BREAK: break-all">
                       <bean:message key="exam.q_standard"/>
                        ...
                        <br>
                       <bean:message key="exam.t_answer"/>
                        <bean:write name="fitinQ" property="t_answer"/>
                        <br>
                       <bean:message key="exam.q_value"/>
                        <bean:write name="fitinQ" property="q_value"/>
                        <br>
                        <bean:message key="exam.t_value"/>
                        <bean:write name="fitinQ" property="t_value"/>
                        <br>
                      </td>
                    </tr>
                  </logic:iterate>
            ...
            <tr>
              <td width="650" bgcolor="#FFFFFF">
                <table width="90%" border="0" cellpadding="1" cellspacing="3" class="ex2">
                  <tr>
                    <td height="29" colspan="2" valign="top">
                      <strong><bean:message key="question.answer"/>锛\uFFFD/strong>
                    </td>
                  </tr>
                    ...
                    <tr>
                     ...
                     <td width="680" style="WORD-BREAK: break-all">
                       <bean:message key="exam.q_standard"/>
                        ...
                        <br>
                       <bean:message key="exam.t_answer"/>
                        <bean:write name="answerQ" property="t_answer"/>
                        <br>
                       <bean:message key="exam.q_value"/>
                        <bean:write name="answerQ" property="q_value"/>
                        <br>
                        <bean:message key="exam.t_value"/>
                        <bean:write name="answerQ" property="t_value"/>
                        <br>
                      </td>
                    </tr>
